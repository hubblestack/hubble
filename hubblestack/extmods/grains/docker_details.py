...
def _get_docker_version():
  ...
  docker_version = osquery_lib.query(query_sql=osquery_sql, osquery_path=osquery_path)
...
def _is_docker_process_running():
  ...
  docker_process = osquery_lib.query(query_sql=osquery_sql, osquery_path=osquery_path)
