            ...
            for tag_data in __tags__[tag]:
                ...
                if audittype == 'blacklist':
                    if not enabled:
                        ...
                        tag_data['failure_reason'] = "Found blacklisted service '{0}' running on the system".format(name)
                ...
                # Whitelisted pattern (must be found and running)
                    ...
                    if enabled:
                        ...
                        tag_data['failure_reason'] = "Could not find requisite service '{0}' running on the system".format(name)
                        ret['Failure'].append(tag_data)
