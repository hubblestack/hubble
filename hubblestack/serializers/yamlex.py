# -*- coding: utf-8 -*-
'''
    hubblestack.serializers.yamlex
    ~~~~~~~~~~~~~~~~~~~~~~~~~~
    ...
    .. code-block:: python
        ...
        from hubblestack.serializers import yamlex
    ...
    .. code-block:: python
        ...
        from hubblestack.serializers import yaml
...
from hubblestack.utils.aggregation import aggregate, Map, Sequence
from hubblestack.utils.odict import OrderedDict
...
class Loader(BaseLoader):  # pylint: disable=W0232
    ...
    for the YAML loading defaults to be manipulated based on needs within hubblestack
