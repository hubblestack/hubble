...
cd build
tar -czvf hubblestack-2.2.0.tar.gz hubblestack-2.2.0/
mkdir -p rpmbuild/{RPMS,SRPMS,BUILD,SOURCES,SPECS,tmp}

cp hubblestack-2.2.0.tar.gz rpmbuild/SOURCES/
cd rpmbuild

cp ../../specs/* SPECS/

rpmbuild --define "_topdir $(pwd)" --define "_tmppath %{_topdir}/tmp" -ba SPECS/hubblestack-el6.spec
cp RPMS/x86_64/hubblestack-2.2.0-1.x86_64.rpm ../../dist/hubblestack-2.2.0-1.el6.x86_64.rpm
rpmbuild --define "_topdir $(pwd)" --define "_tmppath %{_topdir}/tmp" -ba SPECS/hubblestack-el7.spec
cp RPMS/x86_64/hubblestack-2.2.0-1.x86_64.rpm ../../dist/hubblestack-2.2.0-1.el7.x86_64.rpm
