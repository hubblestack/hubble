...
$specFile = $specFile -replace 'a.binaries','a.binaries + [(''libeay32.dll'', ''C:\Python39\libeay32.dll'', ''BINARY'')]';
...
Copy-Item C:/temp/hubble/pkg/windows/hubble*.sha256.txt -Destination C:/data/;
