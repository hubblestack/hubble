...
import hubblestack.modules.temp as temp
import hubblestack.modules.win_file as win_file
...
class WinFileCheckPermsTestCase(TestCase, LoaderModuleMockMixin):
    ...
    def setup_loader_modules(self):
        self.current_user = hubblestack.utils.win_functions.get_current_user(False)
        return {
            win_file: {
                "__utils__": {
