...
import hubblestack.fdg.process
...
class TestProcess():
    ...
    def test__compare_raises_exception_if_arguments_have_invalid_type(self):
        ...
        with pytest.raises(ArgumentValueError):
            hubblestack.fdg.process._compare('foo', 1, 2)
    ...
    def test__compare_returns_correctly_with_ge_comparator(self):
        ...
        ge = greater equal
        """
        ret = hubblestack.fdg.process._compare('ge', 1, 2)
        assert ret is False, '1 >= 2'
        ret = hubblestack.fdg.process._compare('ge', 2, 2)
        assert ret is True, '2 >= 2'
        ret = hubblestack.fdg.process._compare('ge', 2, 1)
    ...
    def test__compare_returns_correctly_with_gt_comparator(self):
        ...
        gt = greater than
        """
        ret = hubblestack.fdg.process._compare('gt', 10, 2)
        assert ret is True, '10 > 2'
        ret = hubblestack.fdg.process._compare('gt', 1, 2)
        assert ret is False, '1 > 2'
        ret = hubblestack.fdg.process._compare('gt', 2, 2)
    ...
    def test__compare_returns_correctly_with_lt_comparator(self):
        ...
        lt = lower than
        """
        ret = hubblestack.fdg.process._compare('lt', 1, 2)
        assert ret is True, '1 < 2'
        ret = hubblestack.fdg.process._compare('lt', 2, 2)
        assert ret is False, '2 < 2'
        ret = hubblestack.fdg.process._compare('lt', 2, 1)
        ret is False, '2 < 1'
    ...
    def test__compare_returns_correctly_with_le_comparator(self):
        ...
        le = lower equal
        """
        ret = hubblestack.fdg.process._compare('le', 1, 2)
        assert ret is True, '1 <= 2'
        ret = hubblestack.fdg.process._compare('le', 2, 2)
        assert ret is True, '2 <= 2'
        ret = hubblestack.fdg.process._compare('le', 2, 1)
    ...
    def test__compare_returns_correctly_with_eq_comparator(self):
        ...
        eq = equal
        """
        ret = hubblestack.fdg.process._compare('eq', 1, 2)
        assert ret is False, '1 == 2'
        ret = hubblestack.fdg.process._compare('eq', 2, 1)
        assert ret is False, '2 == 1'
        ret = hubblestack.fdg.process._compare('eq', 1, 1)
    ...
    def test__compare_returns_correctly_with_ne_comparator(self):
        ...
        ne = not equal
        """
        ret = hubblestack.fdg.process._compare('ne', 1, 2)
        assert ret is True, '1 != 2'
        ret = hubblestack.fdg.process._compare('ne', 2, 1)
        assert ret is True, '2 != 1'
        ret = hubblestack.fdg.process._compare('ne', 1, 1)
    ...
    def test__filter_dict_returns_none_if_filter_values_is_invalid(self):
        ...
        """
        ret = hubblestack.fdg.process._filter_dict(
    ...
    def test__filter_dict_returns_unaltered_dict_if_filter_rules_is_empty(self):
        ...
        """
        expected_ret = {1: 'a', 2: 'b'}
        ret = hubblestack.fdg.process._filter_dict({1: 'a', 2: 'b'}, True, {})
        assert expected_ret == ret
    ...
    def test_filter_dict_returns_none_if_dict_is_invalid(self):
        ...
        status, ret = hubblestack.fdg.process.filter_dict(
    ...
    def test__filter_returns_none_if_input_is_invalid(self):
        ...
        """
        ret = hubblestack.fdg.process._filter([1, 2, 3], {'foo': 1})
    ...
    def test__filter_correctly_filters_sequence_if_input_is_valid(self):
        ...
        expected_ret = [2, 4]
        seq = [1, 2, 3, 4]
        ret = hubblestack.fdg.process._filter(seq, {"gt": 1, "ne": 3, "le": 4})
        assert expected_ret == ret
        # set
        seq = set(seq)
        ret = hubblestack.fdg.process._filter(seq, {"gt": 1, "ne": 3, "le": 4})
        ...
        ret = hubblestack.fdg.process._filter(seq, {"ne": 't'})
        assert expected_ret == ret
    ...
    def test_filter_seq_returns_none_if_input_is_invalid(self):
        ...
        status, ret = hubblestack.fdg.process.filter_seq(
    ...
    def test_get_index_returns_none_if_invalid_input(self):
        ...
        """
        # invalid ``chained``
        status, ret = hubblestack.fdg.process.get_index(starting_list=[1, 2, 3])
        assert status is False, 'invalid chained, should return False'
        assert ret is None, 'invalid chained, should return None'
        # index out of range
        status, ret = hubblestack.fdg.process.get_index(index=4, chained=[1, 2, 3])
        ...
        status, ret = hubblestack.fdg.process.get_index(chained=set([1, 2, 3]))
    ...
    def test_get_index_returns_correctly_if_valid_input(self):
        ...
        expected_ret = 2
        status, ret = hubblestack.fdg.process.get_index(
    ...
    def test_get_key_returns_none_if_invalid_input(self):
        ...
        """
        # invalid ``chained`` type
        status, ret = hubblestack.fdg.process.get_key(key='a', chained=['a', 'b', 'c'])
        assert status is False, 'invalid chained type, should return False'
        assert ret is None, 'invalid chained type, should return None'
        # invalid key
        status, ret = hubblestack.fdg.process.get_key(
    ...
    def test_join_returns_none_if_invalid_arguments(self):
        ...
        """
        # invalid ``chained``
        status, ret = hubblestack.fdg.process.join(chained=1)
        assert status is False
        assert ret is None
        # invalid ``sep``
        status, ret = hubblestack.fdg.process.join(sep=[1, 2], chained=['foo', 'bar'])
        assert status is False
        assert ret is None
    ...
    def test_join_returns_correct_string(self):
        ...
        status, ret = hubblestack.fdg.process.join(
    ...
    def test__sort_returns_none_if_invalid_input(self):
        ...
        """
        # invalid ``seq``
        ret = hubblestack.fdg.process._sort(seq=1, desc=True, lexico=False)
        assert ret is None
        # invalid ``desc``
        ret = hubblestack.fdg.process._sort(seq=[2, 1], desc='yes', lexico=False)
        assert ret is None
        # invalid ``lexico``
        ret = hubblestack.fdg.process._sort(seq=[1, 2, 12, 13], desc=False, lexico=True)
        assert ret is None
    ...
    def test__sort_returns_sorted_seq(self):
        ...
        """
        expected_ret = ['Z', 'a', 'b']
        ret = hubblestack.fdg.process._sort(seq=['b', 'a', 'Z'], desc=False, lexico=False)
        assert expected_ret == ret
        expected_ret = ['b', 'a', 'B']
        ret = hubblestack.fdg.process._sort(
    ...
    def test_sort_returns_none_if_invalid_arguments(self):
        ...
        """
        # invalid ``chained``
        status, ret = hubblestack.fdg.process.sort(seq=2, chained=1)
        assert status is False
        assert ret is None
        # invalid ``desc``
        status, ret = hubblestack.fdg.process.sort(chained=[1, 2, 3], desc='yes')
        assert status is False
        assert ret is None
        # invalid ``lexico``
        status, ret = hubblestack.fdg.process.sort(chained=[1, 2, 3], lexico=True)
        assert status is False
        assert ret is None
    ...
    def test_sort_returns_sorted_seq(self):
        ...
        expected_ret = [3, 2, 1]
        # desc list
        status, ret = hubblestack.fdg.process.sort(
            seq=[1, 2], desc=True, chained=[3])
        assert status is True
        assert expected_ret == ret
        # dict
        expected_ret = [1, 2, 3]
        status, ret = hubblestack.fdg.process.sort(chained={2: 'a', 1: 'b', 3: 'c'})
        assert status is True
        assert expected_ret == ret
        # desc set
    ...
    def test__split_returns_none_if_invalid_arguments(self):
        ...
        the function returns None
        """
        ret = hubblestack.fdg.process._split(phrase=[1, 2, 3], sep=" ", regex=False)
        assert ret is None, "can't split list, should return None"
        ret = hubblestack.fdg.process._split(phrase="foo bar", sep=[1, 2, 3], regex=False)
        assert ret is None, "separator to split by can't be list, should return None"
        ret = hubblestack.fdg.process._split(phrase=[1, 2, 3], sep=" ", regex=True)
        assert ret is None, "can't split list, should return None"
        ret = hubblestack.fdg.process._split(phrase="foo bar", sep=[1, 2, 3], regex=True)
        assert ret is None, "separator to split by can't be list, should return None"
    ...
    def test__split_returns_list_from_string(self):
        ...
        ret = hubblestack.fdg.process._split("foo bar", " ", False)
        assert expected_ret == ret
        # ``sep`` simple regex
        ret = hubblestack.fdg.process._split("foo bar", " ", True)
        assert expected_ret == ret
        # regex
        ret = hubblestack.fdg.process._split("foo    bar", r"\s+", True)
        assert expected_ret == ret
        # invalid ``sep``
        expected_ret = ['foo bar']
        ret = hubblestack.fdg.process._split("foo bar", "?", False)
    ...
    def test_split_returns_none_if_invalid_arguments(self):
        ...
        """
        # invalid ``words``
        status, ret = hubblestack.fdg.process.split([1, 2, 3], chained='ab')
        assert ret is None
        assert status is False
        status, ret = hubblestack.fdg.process.split({1: 'a', 2: 'b'}, chained='ab')
        assert ret is None
        assert status is False
        # invalid ``words`` & ``chained``
        status, ret = hubblestack.fdg.process.split(1, chained=12)
        assert ret is None
        assert status is False
        status, ret = hubblestack.fdg.process.split('foo bar', regex=True)
        assert ret is None
        assert status is False
    ...
    def test_split_returns_list_from_string(self):
        ...
        # valid regex
        status, ret = hubblestack.fdg.process.split(
    ...
    def test_dict_to_list_returns_none_if_invalid_arguments(self):
        ...
        Test that given invalid arguments, the function returns None
        """
        status, ret = hubblestack.fdg.process.dict_to_list(
    ...
    def test_dict_to_list_correctly_returns_list(self):
        ...
        # empty dict
        expected_ret = []
        status, ret = hubblestack.fdg.process.dict_to_list(chained={})
        assert status is False
        assert expected_ret == ret
    ...
    def test__dict_convert_none_returns_none_if_invalid_arguments(self):
        ...
        Test that given invalid arguments, the function returns None
        """
        ret = hubblestack.fdg.process._dict_convert_none([1, 2, 3])
        assert ret is None
        ret = hubblestack.fdg.process._dict_convert_none(1)
        assert ret is None
        expected_ret = {}
        ret = hubblestack.fdg.process._dict_convert_none(defaultdict())
        assert expected_ret == ret
    ...
    def test__dict_convert_none_replaces_empty_string_with_none_in_dict(self):
        ...
        ret = hubblestack.fdg.process._dict_convert_none(
            {1: "", 2: 'a', 3: "None", 4: None})
        assert expected_ret == ret
        # nested dicts
    ...
    def test__seq_convert_none_returns_none_if_invalid_arguments(self):
        ...
        Test that given invalid arguments, the function returns None
        """
        ret = hubblestack.fdg.process._seq_convert_none({1: 'a', 2: 'b'})
        assert ret is None
        ret = hubblestack.fdg.process._seq_convert_none(1)
        assert ret is None
        ret = hubblestack.fdg.process._seq_convert_none(True)
        assert ret is None
    ...
    def test__seq_convert_none_replaces_emtpy_strings_with_none(self):
        ...
        ret = hubblestack.fdg.process._seq_convert_none(
            ['a', {1: ''}, 'b', {1: ''}, 'c'])
        assert expected_ret == ret
        # nested seq & dict
    ...
    def test_dict_convert_none_returns_none_if_invalid_argument(self):
        ...
        Test that given invalid arguments, the function returns None
        """
        status, ret = hubblestack.fdg.process.dict_convert_none(chained='foo bar')
        assert status is False
        assert ret is None
        status, ret = hubblestack.fdg.process.dict_convert_none(
            chained={1: 'a'}, starting_seq=[1, 2])
        assert status is False
        assert ret is None
        expected_ret = []
        status, ret = hubblestack.fdg.process.dict_convert_none(chained=[])
        assert status is False
        assert expected_ret == ret
    ...
    def test_print_string_returns_none_when_invalid_arguments(self):
        ...
        Test that given invalid arguments, the function returns None
        """
        status, ret = hubblestack.fdg.process.print_string(
    ...
    def test__sterilize_dict_returns_none_if_invalid_arguments(self):
        ...
        Test that given invalid arguments, the function returns None
        """
        ret = hubblestack.fdg.process._sterilize_dict(dictionary=[1, 2])
        assert ret is None
        ret = hubblestack.fdg.process._sterilize_dict(dictionary={})
        assert ret == {}
        ret = hubblestack.fdg.process._sterilize_dict(dictionary=12)
        assert ret is None
    ...
    def test__sterilize_dict_removes_none_values_if_nested_dict(self):
        ...
        # flat dict
        expected_ret = {2: 'a'}
        ret = hubblestack.fdg.process._sterilize_dict(
            {1: None, 2: 'a'})
        assert expected_ret == ret
        # nested dicts
    ...
    def test__sterilize_seq_returns_none_if_arguments_are_invalid(self):
        ...
        Test that given invalid arguments, the function returns None
        """
        ret = hubblestack.fdg.process._sterilize_seq(
            {1: 'a', 2: ['b']})
        assert ret is None
        ret = hubblestack.fdg.process._sterilize_seq(12)
        assert ret is None
        ret = hubblestack.fdg.process._sterilize_seq([])
        assert ret == []
    ...
    def test_remove_dict_none_returns_none_if_invalid_arguments(self):
        ...
        assert ret is None
        # invalid ``chained``
        status, ret = hubblestack.fdg.process.dict_remove_none(chained="123")
        assert status is False
        assert ret is None
    ...
    def test_encode_base64_returns_none_if_invalid_arguments_type(self):
        ...
        status, ret = hubblestack.fdg.process.encode_base64(
