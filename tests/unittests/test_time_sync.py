...
import mock
import os
import hubblestack.fdg.time_sync
import pytest
...
class TestTimesync():
    ...
    @mock.patch('hubblestack.fdg.time_sync._query_ntp_server')
    def test_timeCheck_invalidInput_falseReturn(self, mock_offset):
        ...
        status, ret = hubblestack.fdg.time_sync.time_check(['dummy.ntp.org'],
    ...
    def test_timeCheck_emptyInputList_emptyReturn(self):
        ...
        '''
        status, ret = hubblestack.fdg.time_sync.time_check([])
        assert status is False
        assert ret is None
    ...
    def test__queryNtpServer_validServer_validReturn(self):
        ...
        '''
        offset = hubblestack.fdg.time_sync._query_ntp_server('0.pool.ntp.org')
    ...
    def test__queryNtpServer_invalidServer_emptyReturn(self):
        ...
        the query is successful
        '''
        offset = hubblestack.fdg.time_sync._query_ntp_server('dummy.pool.ntp.org')
