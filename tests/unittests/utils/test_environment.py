...
class UtilsTestCase(TestCase):
    ...
    def test_get_module_environment_empty(self):
        ...
        :return:
        '''
        out = hubblestack.utils.environment.get_module_environment({})
        assert out == {}
    ...
    def test_get_module_environment_opts(self):
        ...
        assert hubblestack.utils.environment.get_module_environment(_globals) == expectation
    ...
    def test_get_module_environment_sname_found(self):
        ...
        assert hubblestack.utils.environment.get_module_environment(_globals) == {}
