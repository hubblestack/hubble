...
# Import Salt Libs
import hubblestack.utils.win_osinfo as win_osinfo
import hubblestack.utils.platform


@skipIf(not hubblestack.utils.platform.is_windows(), 'Requires Windows')
@skipIf(NO_MOCK, NO_MOCK_REASON)
class WinOsInfo(TestCase):
    '''
    Test cases for hubblestack/utils/win_osinfo.py
    '''
